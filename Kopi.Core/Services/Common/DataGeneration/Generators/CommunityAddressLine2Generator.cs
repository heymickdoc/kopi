...
/// <summary>
///  Generates community-edition address line 2 data. This is usually a town or city name.
/// </summary>
public class CommunityAddressLine2Generator : IDataGenerator
{
    public string TypeName => "address_line2";
    ...
    {
        var address = _faker.Address.SecondaryAddress();
